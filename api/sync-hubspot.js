...
module.exports = async function handler(req, res) {
  ...
  try {
    const [newKolla, newCust, oldKolla, oldCust, superheta] = await Promise.all([
    ...
    const row = {
      date: today, total_leads: 0,
      kollarom_total: newKolla + oldKolla,
      customers_total: newCust + oldCust,
    ...
    const r = await fetch(`${SUPABASE_URL}/rest/v1/hubspot_funnel`, {
      method: 'POST',
      headers: {
        'apikey': SUPABASE_KEY,
